        ...
        */
        ...
        $icons['unicons'] = array(
            ...
            'icons' => array(
                ...
                array(
                    'keys' => 'lottiefiles',
                    'svg' => '<svg xmlns="http://www.w3.org/2000/svg" class="ghostkit-svg-icon ghostkit-svg-icon-unicons" aria-hidden="true" role="img" fill="currentColor" enable-background="new 0 0 24 24" viewBox="0 0 24 24"><path d="M17,6c-2.8,0-4.4,2.8-5.9,5.5C9.9,13.8,8.7,16,7,16c-0.6,0-1,0.4-1,1s0.4,1,1,1c2.8,0,4.4-2.8,5.9-5.5C14.1,10.2,15.3,8,17,8c0.6,0,1-0.4,1-1S17.6,6,17,6z M19,2H5C3.3,2,2,3.3,2,5v14c0,1.7,1.3,3,3,3h14c1.7,0,3-1.3,3-3V5C22,3.3,20.7,2,19,2z M20,19c0,0.6-0.4,1-1,1H5c-0.6,0-1-0.4-1-1V5c0-0.6,0.4-1,1-1h14c0.6,0,1,0.4,1,1V19z"/></svg>',
                ),
                array(
                    'keys' => 'luggage-cart',
                ...
                array(
                    'keys' => 'microsoft',
                    'svg' => '<svg xmlns="http://www.w3.org/2000/svg" class="ghostkit-svg-icon ghostkit-svg-icon-unicons" aria-hidden="true" role="img" fill="currentColor" enable-background="new 0 0 24 24" viewBox="0 0 24 24"><path d="M2,22h9.5v-9.5H2V22z M2,11.5h9.5V2H2V11.5z M12.5,2v9.5H22V2H12.5z M12.5,22H22v-9.5h-9.5V22z"/></svg>',
                ),
                array(
                    'keys' => 'minus-circle',
                ...
                array(
                    'keys' => 'okta',
                    'svg' => '<svg xmlns="http://www.w3.org/2000/svg" class="ghostkit-svg-icon ghostkit-svg-icon-unicons" aria-hidden="true" role="img" fill="currentColor" enable-background="new 0 0 24 24" viewBox="0 0 24 24"><path d="M12,2L12,2C6.5,2,2,6.5,2,12s4.5,10,10,10s10-4.5,10-10C22,6.5,17.5,2,12,2z M17,12c0,2.8-2.2,5-5,5c-2.8,0-5-2.2-5-5c0-2.8,2.2-5,5-5C14.8,7,17,9.2,17,12L17,12z"/></svg>',
                ),
                array(
                    'keys' => 'opera-alt',
