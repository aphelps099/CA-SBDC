	...
	*/
	public function get_control_output($controlEditingTypeModel){
		...
		<div class="sb-control-input-ctn sbsw-fs">
			...
			<input type="text" class="sb-control-input sbsw-fs" v-model="<?php echo $controlEditingTypeModel ?>[control.id]" @change.prevent.default="changeSettingValue(control.id, false,false, control.ajaxAction ? control.ajaxAction : false)"  :placeholder="control.placeholder ? control.placeholder : ''">
