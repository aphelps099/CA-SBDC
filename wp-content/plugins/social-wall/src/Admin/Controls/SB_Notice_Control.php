...
class SB_Notice_Control extends SB_Controls_Base{
	...
	*/
	public function get_control_output($controlEditingTypeModel){
		?>
		<div class="sb-control-notice-ctn sbsw-fs" @click.prevent.default="control.containerAction != undefined ? noticeClickAction(control.containerAction) : false" :data-notice-action="control.containerAction != undefined ? 'true': false">
			<div class="sb-control-notice-content sbsw-fs">
