...
const FacebookFeedItem = ( { post, feedSettings, pluginName } ) => {
        ...
        <>
            <div className="sbsw-follow">
                <a href={post?.account_link} target="_blank" rel="nofollow noopener">
                    <>
                        {SbUtils.printIcon( 'facebook-icon-2', 'follow-icon' ) }
                        <span>Follow</span>
                    </>
                </a>
            </div>
            <div className="sbsw-post-item-inner">
                    ...
                    <div className="sbsw-identity">
                                ...
                                { 
                                    feedSettings?.postElements.includes('date') && (
                                        <div className="sbsw-date">
                                            { feedSettings?.dateBeforeText + ' ' + SbUtils.printDate(toTimestamp(post?.updated_time), feedSettings ) + ' ' + feedSettings?.dateAfterText}
                                        </div>
                                    )
                                }
                            </div>
                        ...
                        <div className="sbsw-icon">
                            <a href={post.permalink}>
                                { SbUtils.printIcon( 'facebook-icon-2' ) }
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div className="sbsw-item-footer">
                    <div className="sbsw-item-bottom">
                        { 
                            feedSettings?.postElements.includes('summary') && pluginName == 'facebook' && (
...
export default FacebookFeedItem;