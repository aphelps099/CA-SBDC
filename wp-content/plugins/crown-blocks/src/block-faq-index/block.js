...
registerBlockType('crown-blocks/faq-index', {
	title: 'FAQ Index',
	description: 'Displays all the FAQs published.',
	icon: 'info',
	category: 'widgets',
		...
		return [
			...
			<InspectorControls key="inspector-controls">
				...
				<PanelBody title={ 'Appearance' } initialOpen={ true }>
					...
					<SelectControl
						label="Number of FAQs to display per page"
						value={ postsPerPage }
			...
			<div class="crown-block-editor-container">
				...
				<ServerSideRender block="crown-blocks/faq-index" attributes={ attributes } />
