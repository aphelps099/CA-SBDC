...
registerBlockType('crown-blocks/event-index', {
	title: 'Event Index',
	description: 'Displays all the events published.',
	icon: 'calendar',
	category: 'widgets',
		...
		return [
			...
			<InspectorControls key="inspector-controls">
				...
				<PanelBody title={ 'Appearance' } initialOpen={ true }>
					...
					<SelectControl
						label="Number of events to display per page"
						value={ postsPerPage }
			...
			<div class="crown-block-editor-container">
				...
				<ServerSideRender block="crown-blocks/event-index" attributes={ attributes } />
