...
registerBlockType('crown-blocks/job-index', {
	title: 'Job Index',
	description: 'Displays all the jobs published.',
	icon: 'businessman',
	category: 'widgets',
		...
		return [
			...
			<InspectorControls key="inspector-controls">
				...
				<PanelBody title={ 'Appearance' } initialOpen={ true }>
					...
					<SelectControl
						label="Number of jobs to display per page"
						value={ postsPerPage }
			...
			<div class="crown-block-editor-container">
				...
				<ServerSideRender block="crown-blocks/job-index" attributes={ attributes } />
