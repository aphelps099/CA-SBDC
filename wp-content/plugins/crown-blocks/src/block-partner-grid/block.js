...
const ALLOWED_BLOCKS = [ 'crown-blocks/partner-grid-cell' ];


registerBlockType('crown-blocks/partner-grid', {
	title: 'Partner Grid',
	icon: 'screenoptions',
	category: 'layout',
	keywords: [ 'columns', 'logos', 'crown-blocks' ],
	...
	edit: ({ attributes, className, isSelected, setAttributes }) => {
		...
		const TEMPLATE = [
			[ 'crown-blocks/partner-grid-cell', {} ]
		];
