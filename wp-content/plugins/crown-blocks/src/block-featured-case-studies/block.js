...
registerBlockType('crown-blocks/featured-case-studies', {
	title: 'Featured Case Studies',
	description: 'Display the latest case studies published to the portfolio.',
	icon: 'portfolio',
	category: 'widgets',
	...
	attributes: {
		maxPostCount:  { type: 'string', default: '2' },
	...
	edit: withSelect((select) => {
		...
		return [
			...
			<InspectorControls key="inspector-controls">
				...
				<PanelBody title={ 'Filtering Options' } initialOpen={ true }>
					...
					{ !! !manuallySelectPosts && <ToggleControl
						label={ 'Exclude case studies featured in other featured case study feeds above this on the page (note: does not affect output in editor)' }
			...
			<div class="crown-block-editor-container">
				...
				<ServerSideRender block="crown-blocks/featured-case-studies" attributes={ attributes } />
