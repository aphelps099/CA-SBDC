...
registerBlockType('crown-blocks/webinar-index', {
	title: 'Webinar Index',
	description: 'Displays all the webinars published to the webinar library.',
	icon: 'video-alt3',
	category: 'widgets',
		...
		return [
			...
			<InspectorControls key="inspector-controls">
				...
				<PanelBody title={ 'Appearance' } initialOpen={ true }>
					...
					<SelectControl
						label="Number of webinars to display per page"
						value={ postsPerPage }
			...
			<div class="crown-block-editor-container">
				...
				<ServerSideRender block="crown-blocks/webinar-index" attributes={ attributes } />
