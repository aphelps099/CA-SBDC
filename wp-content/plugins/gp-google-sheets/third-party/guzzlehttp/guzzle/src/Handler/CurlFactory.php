...
namespace GP_Google_Sheets\Dependencies\GuzzleHttp\Handler;

use GP_Google_Sheets\Dependencies\GuzzleHttp\Exception\ConnectException;
use GP_Google_Sheets\Dependencies\GuzzleHttp\Exception\RequestException;
use GP_Google_Sheets\Dependencies\GuzzleHttp\Promise as P;
...
use GP_Google_Sheets\Dependencies\GuzzleHttp\Psr7\LazyOpenStream;
use GP_Google_Sheets\Dependencies\GuzzleHttp\TransferStats;
use GP_Google_Sheets\Dependencies\GuzzleHttp\Utils;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf) : void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \GP_Google_Sheets\Dependencies\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \GP_Google_Sheets\Dependencies\GuzzleHttp\Psr7\Utils::streamFor($sink);
