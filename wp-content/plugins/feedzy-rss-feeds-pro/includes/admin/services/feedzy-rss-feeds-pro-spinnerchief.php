...
class Feedzy_Rss_Feeds_Pro_Spinnerchief implements Feedzy_Rss_Feeds_Pro_Services_Interface {
	 ...
	 * @since   ?
	 * @access  private
	 * @var     array $_languages The languages supported by the API and their mapping with the languages in WordPress.
	 */
	...
	public function call_api( $settings, $text, $type, $additional = array() ) {
		...
		if ( isset( $additional['lang'] ) ) {
			$languages = apply_filters( 'feedzy_spinnerchief_languages', self::$_languages );
