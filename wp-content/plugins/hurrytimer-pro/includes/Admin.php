...
?>
    ...
    public function enqueueScripts() {
        ...
        wp_enqueue_script(
            "codemirror",
            HURRYT_URL . '/assets/js/codemirror.js',
            [],
            "5.42.2",
            true
        );
        ...
        wp_enqueue_script(
            "codemirror-css",
            HURRYT_URL . 'assets/js/codemirror-css.js',
            ['codemirror'],
            "5.42.2",
            true
        );
    ...
    public function menu() {
        ...
        add_submenu_page(
            'hurrytimer',
            __('Manage License', 'hurrytimer'),
            __('License', 'hurrytimer'),
            apply_filters('hurryt_admin_capability', 'manage_options', 'settings'),
            'hurrytimer_license',
            [$this, 'manage_license']
        );
    ...
    function manage_license() {
        ...
        <div class="wrap">
            ...
            <?php
            do_action('hurryt_manage_license');
            ?>
        </div>
        <?php
    }
