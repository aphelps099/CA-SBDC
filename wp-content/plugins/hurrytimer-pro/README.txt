...
* Fixed a problem regarding some recurring timers not displaying the accurate hours.
...
* Added an option to pause an expired recurring timer before restarting

= 2.7.4 =

* Fix an issue with recurring timer not restarted when session is expired.
* Declare compatibility with WooCommerce 6.8
