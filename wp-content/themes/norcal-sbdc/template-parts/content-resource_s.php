...
function content_resource_s_filter_crown_localized_post_url( $url, $post_id ) {
...
add_filter( 'crown_localized_post_url', 'content_resource_s_filter_crown_localized_post_url', 100, 2 );

function content_resource_s_filter_crown_localized_index_url( $url, $option_key ) {
	$current_site_id = get_current_blog_id();
	restore_current_blog();
